...
import aashish.coventry.esoftwarica.model.StudentsList;
...
public class AddFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        Address = btnadd.getText().toString().trim();
        if (rbMale.isChecked()) {
            Gender = "Male";
        }
        ...
        if (!TextUtils.isEmpty(Name) && !TextUtils.isEmpty(Age) && !TextUtils.isEmpty(Address)) {
            ...
            StudentsList check = new StudentsList();
            check.setStudentList(studentList);
